        ...
        <div className="auth-left-content">
          ...
          <div className="auth-left-body">
            ...
            <p className="auth-hero-desc">
              Tham gia cùng 50,000+ nghệ nhân và những người yêu môi trường để
              kiến tạo tương lai xanh từ những giá trị cũ.
            </p>
            <div className="auth-testimonial-card">
              <p className="auth-testimonial-quote">
                "Tôi tìm thấy linh hồn trong từng món đồ thủ công tại đây. Không
                chỉ là mua sắm, đó là sự tôn trọng thiên nhiên."
              </p>
          ...
          <div className="auth-left-footer">
            <span className="auth-copyright">
              © 2024 RE-ART Marketplace. Inspired by Nature.
            </span>
          </div>
        </div>
      </div>
          ...
          {activeTab === "login" ? (
            <div className="auth-form-section">
              <div className="auth-form-header">
                ...
                <p className="auth-form-subtitle">
                  Tiếp tục hành trình mua sắm bền vững của bạn
                </p>
              </div>
                  ...
                  <div className="auth-input-wrapper">
                    ...
                    >
                      {showPassword ? (
                        ...
                        >
                          <path
                            d="M10 3C6.13 3 2.73 5.11 1.08 8.38C2.73 11.65 6.13 13.75 10 13.75C13.87 13.75 17.27 11.65 18.92 8.38C17.27 5.11 13.87 3 10 3ZM10 11.88C7.86 11.88 6.12 10.14 6.12 8C6.12 5.86 7.86 4.12 10 4.12C12.14 4.12 13.88 5.86 13.88 8C13.88 10.14 12.14 11.88 10 11.88ZM10 5.6C8.68 5.6 7.6 6.68 7.6 8C7.6 9.32 8.68 10.4 10 10.4C11.32 10.4 12.4 9.32 12.4 8C12.4 6.68 11.32 5.6 10 5.6Z"
                            fill="#2D4B37"
                            fillOpacity="0.3"
                          />
                        </svg>
            ...
            <div className="auth-form-section">
              <div className="auth-form-header">
                ...
                <p className="auth-form-subtitle">
                  Bắt đầu hành trình sống xanh của bạn ngay hôm nay
                </p>
              </div>
