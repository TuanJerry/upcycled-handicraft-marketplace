const BANNER_IMG =
  "https://api.builder.io/api/v1/image/assets/TEMP/9e4201ddd87fd3215c7d5029b3859e671d65d22b?width=1440";
const AVATAR_1 =
  "https://api.builder.io/api/v1/image/assets/TEMP/a30a10014afb77aa24e8b2f705174e5c2890c4f1?width=200";
const PRODUCT_IMG =
  "https://api.builder.io/api/v1/image/assets/TEMP/9e4201ddd87fd3215c7d5029b3859e671d65d22b?width=400";
...
export const STORES: StoreData[] = [
    ...
    products: [
      {
        ...
        ecoScore: 95,
        description:
          "Được chế tác thủ công từ gỗ pallet tái chế, mỗi chiếc đồng hồ mang một vân gỗ độc đáo không lặp lại. Bộ máy Nhật Bản bền bỉ, thiết kế tối giản tôn vinh vẻ đẹp tự nhiên của gỗ.",
        materials: [
          { name: "Gỗ pallet tái chế", percentage: 85 },
          { name: "Kim loại không gỉ", percentage: 15 },
        ],
        details: [
          "Kích thước: 30cm × 30cm | Dày: 4cm",
          "Máy Nhật Bản chính xác cao",
          "Hoàn thiện bằng dầu tự nhiên không độc hại",
        ],
        craftNote:
          "Mỗi sản phẩm được chà nhám và đánh bóng thủ công qua 5 bước, đảm bảo bề mặt mịn màng và bền đẹp theo thời gian.",
      },
      {
        id: "2",
        image: PRODUCT_IMG,
        name: 'Túi Canvas "Mâm Xanh"',
        category: "Phụ kiện organic",
        price: "320.000đ",
        rating: 9.5,
        ecoScore: 92,
      },
      {
        id: "3",
        image: PRODUCT_IMG,
        name: "Bộ nến đậu nành Organic",
        category: "Decor & Quà tặng",
        price: "195.000đ",
        rating: 9.2,
        ecoScore: 97,
      },
      {
        id: "4",
        image: PRODUCT_IMG,
        name: 'Kệ bút "Đại Dương"',
        category: "Văn phòng xanh",
        price: "180.000đ",
        rating: 9.0,
        ecoScore: 90,
      },
      {
        id: "5",
        image: PRODUCT_IMG,
        name: "Bộ dụng cụ Tre tự nhiên",
        category: "Gia dụng bền vững",
        price: "125.000đ",
        rating: 10,
        ecoScore: 99,
      },
    ...
    workshops: [
      {
        ...
        description:
          "Học cách xử lý gỗ cũ và tự tay đóng những món quà xinh xắn cho người thân.",
        duration: "3 Giờ",
        maxParticipants: 10,
        price: "350.000đ",
      },
  ...
  },
  {
    ...
    description:
      "Tái sinh những thước vải thừa thành phụ kiện thời trang độc bản.",
    productCount: 32,
    workshopCount: 2,
    story:
    ...
    workshops: [
      {
        ...
        description:
          "Học cách biến những bộ quần áo cũ thành chiếc túi vải xinh xắn và độc đáo.",
        duration: "2 Giờ",
        maxParticipants: 8,
        price: "250.000đ",
      },
